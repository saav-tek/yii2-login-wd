...
class Lock extends Validator
{
    ...
    public function validateAttribute($model, $attribute)
    {
        ...
        //Account is locked
            ...
            Yii::error("Account LOCKED - Failed login attempt " . $loginAttempt->attempts . ": $model->username", get_class($this) . "::lock");
        ...
        //Failed login attempt
            ...
            //Lock account
                ...
                Yii::warning("Failed login attempt " . $loginAttempt->attempts . "/$this->attempts: $model->username", get_class($this) . "::fail");
            }
        ...
        //No errors - login succeeded, clear previous failed attempts
            ...
            Yii::info("Login: $model->username", get_class($this) . "::login");
        }   
    }
}